    ...
    questions: [
        ...
        answer: (
          <span>
            <p>
              ...
              “Terms”), are entered into between Incrementum Finance.
              (“Incrementum,” “we,” “us” and “our”) and you or the company or
              other legal entity you represent (“you” or “your”), and constitute
              a binding legal agreement. Please read these Terms carefully, as
              these Terms govern your use of our Portal and our Services, and
              expressly cover your rights and obligations, and our disclaimers
              and limitations of legal liability, relating to such use. By
              accessing or using our Portal or our Services, you accept and
              agree to be bound by and to comply with these Terms, including the
              mandatory arbitration provision in Section 12. If you do not agree
            ...
            <p>
              ...
              by Incrementum. The information in Section 9 provides important
              details about the legal obligations associated with your use of
              the Incrementum open-source software. By accessing or using our
              Portal or our Services, you agree that Incrementum does not
              provide execution or clearing services of any kind and is not
              responsible for the execution or clearing of transactions
              automated through Incrementum open-source software.
            </p>
          </span>
        ),
      },
        ...
        answer: (
          <span>
            ...
            <p>
              ...
              over Incrementum, you, the Portal or the Services, or as otherwise
              duly enacted, enforceable by law, the common law or equity.
            </p>
            <p>
              1.2 “BNB” means the Binance Smart Chain utility token that may be
              used to purchase computational resources to run decentralized
              applications or perform actions on the Binance Smart Chain.
            </p>
            <p>
              1.3 “Binance Smart Chain Address” means the unique public key
              cryptocurrency identifier that points to an Binance Smart
              Chain-compatible wallet to which BNB may be sent or stored.1.5
              “Binance Smart Chain” means the underlying blockchain
              infrastructure which the Portal leverages to perform portions of
              the Services.
            </p>
            <p>
            ...
            <p>
              1.5 “Portal” means the Incrementum site located at
              Incrementum.finance, and all associated sites linked thereto by
              Incrementum and its Affiliates, which includes, for certainty,
              Incrementum&apos;s decentralized application layer on the Binance
              Smart Chain.
            </p>
      ...
      },
      {
        ...
        answer: (
          <span>
            ...
            <p>
              3.2 Binance Smart Chain Gas Charges - Some Services involve the
              use of the Binance Smart Chain, which may require that you pay a
              fee, commonly known as “Binance Smart Chain Gas Charges,” for the
              computational resources required to perform a transaction on the
              Binance Smart Chain . You acknowledge and agree that Incrementum
              has no control over: (a) any Binance Smart Chain transactions; (b)
              the method of payment of any Binance Smart Chain Gas Charges; or
              (c) any actual payments of Binance Smart Chain Gas Charges.
              Accordingly, you must ensure that you have a sufficient balance of
              BNB stored at your Binance Smart Chain Address to complete any
              transaction on the Binance Smart Chain before initiating such
              Binance Smart Chain transaction. We will make reasonable efforts
              to notify you of any Binance Smart Chain Gas Charges before
              initiating any Services that require the use of the Binance Smart
              Chain.
            </p>
            <p>
            ...
            <p>
              3.4 No Broker, Legal or Fiduciary Relationship - Incrementum is
              not your broker, lawyer, intermediary, agent, or advisor and has
              no fiduciary relationship or obligation to you regarding any other
            ...
            <p>
              ...
              maintain the security and confidentiality of your Binance Smart
              Chain Address.
            </p>
            <p>
              ...
              techniques or security measures that Incrementum employs on the
              Portal, or attempt to access any service or area of the Portal or
              the Services that you are not authorized to access; (e) use the
            ...
            <p>
              ...
              accept the risks associated with your Binance Smart Chain Address,
              the Binance Smart Chain, BNB and option Positions; and (d) accept
              ...
              to any option Positions. You hereby assume, and agree that
              Incrementum will have no responsibility or liability for, such
              risks. You hereby irrevocably waive, release and discharge all
              claims, whether known or unknown to you, against Incrementum, its
            ...
            <p>
              ...
              users via the Incrementum Platform as a result of your use of the
              Portal (collectively, “Your Content”) through your use of the
              Services or the Portal, including, without limitation, for
              promoting Incrementum (or its Affiliates), the Services or the
              Portal. You represent and warrant that: (a) you own Your Content
              or have the right to grant the rights and licenses in these Terms;
              and (b) Your Content and our use of Your Content, as licensed
              herein, does not and will not violate, misappropriate or infringe
        ...
        answer: (
          <span>
            <p>
              ...
              https://Incrementum.finance/privacy for information about how we
        ...
        answer: (
          <span>
            <p>
              ...
              as between you and Incrementum, Incrementum owns the Portal and
              the Services, including all technology, content and other
              materials used, displayed or provided on the Portal or in
              ...
              of the Portal and the Services that are proprietary to
              Incrementum.
            </p>
            <p>
              5.2 - Trademarks Any of Incrementum&apos;s product or service
              names, logos, and other marks used in the Portal or as a part of
              the Services, including Incrementum&apos;s name and logo are
              trademarks owned by Incrementum, its Affiliates or its applicable
              licensors. You may not copy, imitate or use them without
              Incrementum&apos;s (or the applicable licensor’s) prior written
              consent.
            </p>
          </span>
        ),
        ...
        answer: (
          <span>
            <p>
              ...
              electronic copies of our Communications by sending a message in
              our telegram group.
            </p>
          </span>
        ),
        ...
        answer: (
          <span>
            <p>
              ...
              connection with, the Portal; (b) Binance Smart Chain assets
              associated with your Binance Smart Chain Address; (c) any feedback
              or user content you provide to the Portal, if any; (d) your
              violation of these Terms; or (e) your infringement or
              misappropriation of the rights of any other person or entity. If
              you are obligated to indemnify any Indemnified Party, Incrementum
              (or, at its discretion, the applicable Indemnified Party) will
              have the right, in its sole discretion, to control any action or
              proceeding and to determine whether Incrementum wishes to settle,
      ...
      },
      {
        ...
        answer: (
          <span>
            <p>
              Incrementum is a developer of open-source software. Incrementum
              does not operate a virtual currency or derivatives exchange
              platform or offer trade execution or clearing services and
              therefore has no oversight, involvement, or control with respect
              to your transactions. All transactions between users of
              Incrementum open-source software are executed peer-to-peer
              directly between the users’ digital wallets through a smart
              contract.
            </p>
            <p>
              As a user of Incrementum, you declare that you are not a citizen
              or resident of any jurisdiction in which either the use of any of
              the Services, exchange, purchase, receipt, or holding of any
              Tokens is prohibited, restricted, curtailed, hindered, impaired or
              otherwise adversely affected by any Applicable Laws;
            </p>
          </span>
        ),
      },
        ...
        answer: (
          <span>
            <p>
              ...
              non-performance of the Services, your BNB, option Positions or any
              other product, service or other item provided by or on behalf of
              us, whether under contract, tort (including negligence), civil
              ...
              Incrementum in any way responsible for the execution or settlement
              of transactions between users of Incrementum open-source software.
            </p>
          </span>
        ),
      },
        ...
        answer: (
          <span>
            ...
            <p>
              ...
              arbitration agreement shall be governed by the laws of the Cayman
              Islands.
            </p>
            <p>
